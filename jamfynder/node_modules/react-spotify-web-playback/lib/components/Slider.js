...
var Slider = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Slider.prototype, "render", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            ...
            return ((0, jsx_runtime_1.jsx)(Wrapper, __assign({ onMouseEnter: onToggleMagnify, onMouseLeave: onToggleMagnify, style: { sliderHeight: isMagnified ? styles.sliderHeight + 4 : styles.sliderHeight } }, { children: (0, jsx_runtime_1.jsx)(react_range_slider_1.default, { axis: "x", onChange: this.handleChangeRange, styles: {
                        options: {
                            thumbBorder: 0,
