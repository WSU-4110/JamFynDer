...
var SpotifyWebPlayer = /** @class */ (function (_super) {
    ...
    function SpotifyWebPlayer(props) {
        ...
        Object.defineProperty(_this, "handleFavoriteStatusChange", {
            ...
            value: function (status) {
                ...
                /* istanbul ignore else */
                if (isSaved !== status) {
                    _this.handleCallback(__assign(__assign({}, _this.state), { isSaved: status, type: TYPE.FAVORITE }));
                }
            }
        });
                    ...
                    switch (_c.label) {
                        ...
                        case 3:
                            if (previousState.status !== status) {
                                this.handleCallback(__assign(__assign({}, this.state), { type: TYPE.STATUS }));
                            }
                            if (!(previousState.currentDeviceId !== currentDeviceId && currentDeviceId)) return [3 /*break*/, 6];
                            if (!isReady) {
                                this.handleCallback(__assign(__assign({}, this.state), { type: TYPE.DEVICE }));
                            }
                        ...
                        case 6:
                            if (previousState.track.id !== track.id && track.id) {
                                this.handleCallback(__assign(__assign({}, this.state), { type: TYPE.TRACK }));
                                if (showSaveIcon) {
                        ...
                        case 7:
                            _c.sent();
                            this.handleCallback(__assign(__assign({}, this.state), { type: TYPE.PLAYER }));
                            _c.label = 8;
                        case 8:
    ...
    Object.defineProperty(SpotifyWebPlayer.prototype, "render", {
        ...
        value: function () {
            ...
            var output = _jsx(Loader, { styles: this.styles });
            var info;
            if (isPlaybackError) {
                info = _jsx("p", { children: error });
            }
            if (isReady) {
                /* istanbul ignore else */
                if (!info) {
                    info = (_jsx(Info, { isActive: isActive, locale: localeMerged, onFavoriteStatusChange: this.handleFavoriteStatusChange, showSaveIcon: showSaveIcon, styles: this.styles, token: token, track: track, updateSavedStatus: updateSavedStatus }));
                }
                output = (_jsxs(_Fragment, { children: [_jsx("div", { children: info }), _jsx(Controls, { isExternalDevice: this.isExternalPlayer, isPlaying: isPlaying, locale: localeMerged, nextTracks: nextTracks, onClickNext: this.handleClickNext, onClickPrevious: this.handleClickPrevious, onClickTogglePlay: this.handleClickTogglePlay, previousTracks: previousTracks, styles: this.styles }), _jsx(Actions, { currentDeviceId: currentDeviceId, deviceId: deviceId, devices: devices, isDevicesOpen: isUnsupported && !deviceId, locale: localeMerged, onClickDevice: this.handleClickDevice, playerPosition: playerPosition, setVolume: this.setVolume, styles: this.styles, volume: volume })] }));
            }
            if (status === STATUS.ERROR) {
                output = (_jsxs(ErrorMessage, __assign({ styles: this.styles }, { children: [name, ": ", error] })));
            }
            return (_jsxs(Player, __assign({ ref: this.ref, styles: this.styles }, { children: [isReady && (_jsx(Slider, { isMagnified: isMagnified, onChangeRange: this.handleChangeRange, onToggleMagnify: this.handleToggleMagnify, position: position, styles: this.styles })), _jsx(Content, __assign({ styles: this.styles }, { children: output }))] })));
        }
    });
