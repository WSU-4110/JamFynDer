...
var Devices = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Devices.prototype, "render", {
        ...
        value: function () {
            ...
            return (_jsx(Wrapper, __assign({ style: {
                    altColor: altColor,
                    bgColor: bgColor,
                    c: currentDeviceId && deviceId && currentDeviceId !== deviceId ? activeColor : color,
                    p: playerPosition,
                } }, { children: !!devices.length && (_jsxs(_Fragment, { children: [isOpen && (_jsx(ClickOutside, __assign({ onClick: this.handleClickToggleDevices }, { children: devices.map(function (d) { return (_jsx("button", __assign({ className: d.id === currentDeviceId ? 'rswp__devices__active' : undefined, "data-id": d.id, onClick: _this.handleClickSetDevice, type: "button" }, { children: d.name }), d.id)); }) }))), _jsx("button", __assign({ "aria-label": title, onClick: this.handleClickToggleDevices, title: title, type: "button" }, { children: _jsx(DevicesIcon, {}) }))] })) })));
        }
    });
    return Devices;
}(React.PureComponent));
