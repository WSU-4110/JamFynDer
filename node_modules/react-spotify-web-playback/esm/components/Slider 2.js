...
var Slider = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Slider.prototype, "render", {
        ...
        value: function () {
            ...
            return (_jsx(Wrapper, __assign({ onMouseEnter: onToggleMagnify, onMouseLeave: onToggleMagnify, style: { sliderHeight: isMagnified ? styles.sliderHeight + 4 : styles.sliderHeight } }, { children: _jsx(RangeSlider, { axis: "x", onChange: this.handleChangeRange, styles: {
                        options: {
                            thumbBorder: 0,
