...
var Info = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Info.prototype, "componentDidMount", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(Info.prototype, "componentDidUpdate", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(Info.prototype, "componentWillUnmount", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(Info.prototype, "render", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            ...
            if (showSaveIcon && id) {
                icon = (_jsx("button", __assign({ className: isSaved ? 'rswp__active' : undefined, onClick: this.handleClickIcon, type: "button" }, { children: isSaved ? _jsx(Favorite, {}) : _jsx(FavoriteOutline, {}) })));
            }
            var classes = [];
            if (isActive) {
                classes.push('rswp__active');
            }
            return (_jsxs(Wrapper, __assign({ className: classes.join(' '), style: { h: height } }, { children: [image && (_jsx("a", __assign({ "aria-label": title, href: getSpotifyLink(uri), rel: "noreferrer", target: "_blank", title: title }, { children: _jsx("img", { alt: name, src: image }) }))), !!name && (_jsxs(Title, __assign({ style: { c: color, h: height, activeColor: activeColor, trackArtistColor: trackArtistColor, trackNameColor: trackNameColor } }, { children: [_jsxs("p", { children: [_jsx("span", { children: _jsx("a", __assign({ "aria-label": title, href: getSpotifyLink(uri), rel: "noreferrer", target: "_blank", title: title }, { children: name })) }), icon] }), _jsx("p", __assign({ title: artists.map(function (d) { return d.name; }).join(', ') }, { children: artists.map(function (artist, index) {
                                    var artistTitle = getSpotifyLinkTitle(artist.name, locale.title);
                                    return (_jsxs("span", { children: [index ? ', ' : '', _jsx("a", __assign({ "aria-label": artistTitle, href: getSpotifyLink(artist.uri), rel: "noreferrer", target: "_blank", title: artistTitle }, { children: artist.name }))] }, artist.uri));
                                }) }))] })))] })));
        }
    });
    return Info;
